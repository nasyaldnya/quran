...
export const Icons = {
  ...
  next: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 18l8.5-6L6 6v12zm2-8.14L11.03 12 8 14.14V9.86zM16 6h2v12h-2z"/></svg>`,
  prev: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 6h2v12H6zm3.5 6 8.5 6V6z"/></svg>`,
  shuffle: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M10.59 9.17 5.41 4 4 5.41l5.17 5.17zm4.76-.18 3.65 3.65-3.65 3.65V14h-.34c-.96 0-1.86-.48-2.56-1.24l-1.4-1.57-1.42 1.42 1.37 1.53C11.68 15.38 13.09 16 14.65 16H16v2l4-4-4-4v2h-.65zm-4.76 7.01L8.08 17.6 9.5 19l5.17-5.17-1.41-1.42z"/></svg>`,
  ...
  queue: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 9h14V7H3v2zm0 4h14v-2H3v2zm0 4h14v-2H3v2zm16 0h2v-2h-2v2zm0-10v2h2V7h-2zm0 6h2v-2h-2v2z"/></svg>`,
