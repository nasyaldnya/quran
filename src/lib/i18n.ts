...
export interface Translations {
  ...
  feat_reciters: string
  feat_reciters_desc: string
  feat_tajweed: string
  feat_tajweed_desc: string
  feat_mushaf: string
  feat_mushaf_desc: string
  feat_memorize: string
  feat_memorize_desc: string
  feat_compare: string
  feat_compare_desc: string
  feat_i18n: string
...
const translations: Record<string, Translations> = {
  ar: {
    ...
    features_subtitle: 'كل ما تحتاجه لقراءة والاستماع إلى القرآن الكريم.',
    feat_reciters: 'أكثر من 500 قارئ',
    feat_reciters_desc: 'استمع إلى تلاوات مئات القراء من حول العالم.',
    feat_tajweed: 'تجويد ملون',
    feat_tajweed_desc: 'أحكام التجويد معروضة بألوان مميزة.',
    feat_mushaf: '49 إصداراً للمصحف',
    feat_mushaf_desc: 'إصدارات رسمية من مجمع الملك فهد.',
    feat_memorize: 'وضع الحفظ',
    feat_memorize_desc: 'إخفاء النص تدريجياً لاختبار حفظك.',
    feat_compare: 'مقارنة القراء',
    feat_compare_desc: 'مشغلا صوت مستقلان جنباً إلى جنب.',
    feat_i18n: '6 لغات',
    feat_i18n_desc: 'واجهة بالعربية والإنجليزية والفرنسية والتركية والإسبانية والإندونيسية.',
  ...
  eng: {
    ...
    features_subtitle: 'Everything you need to read and listen to the Holy Quran.',
    feat_reciters: '500+ Reciters',
    feat_reciters_desc: 'Listen to recitations from hundreds of world-renowned reciters.',
    feat_tajweed: 'Color-Coded Tajweed',
    feat_tajweed_desc: 'Tajweed rules displayed with color coding.',
    feat_mushaf: '49 Mushaf Editions',
    feat_mushaf_desc: 'Official editions from King Fahd Complex.',
    feat_memorize: 'Memorization Mode',
    feat_memorize_desc: 'Progressively hide text to test your memorization.',
    feat_compare: 'Reciter Comparison',
    feat_compare_desc: 'Two independent audio players side by side.',
    feat_i18n: '6 Languages',
    feat_i18n_desc: 'Interface in Arabic, English, French, Turkish, Spanish, and Indonesian.',
  ...
  fr: {
    ...
    features_subtitle: 'Tout ce dont vous avez besoin pour lire et écouter le Saint Coran.',
    feat_reciters: '500+ Récitants',
    feat_reciters_desc: 'Écoutez des centaines de récitants du monde entier.',
    feat_tajweed: 'Tajweed en Couleur',
    feat_tajweed_desc: 'Règles de tajweed avec code couleur.',
    feat_mushaf: '49 Éditions',
    feat_mushaf_desc: 'Éditions officielles du Complexe Roi Fahd.',
    feat_memorize: 'Mémorisation',
    feat_memorize_desc: 'Masquez le texte progressivement pour pratiquer.',
    feat_compare: 'Comparer Récitants',
    feat_compare_desc: 'Deux lecteurs audio indépendants.',
    feat_i18n: '6 Langues',
    feat_i18n_desc: 'Interface en arabe, anglais, français, turc, espagnol et indonésien.',
  ...
  tr: {
    ...
    feat_tajweed_desc: 'Tecvid kuralları renk kodlarıyla gösterilir.',
    feat_mushaf: '49 Mushaf Baskısı',
    feat_mushaf_desc: 'Kral Fahd Kompleksi resmi baskıları.',
    feat_memorize: 'Ezberleme Modu',
    feat_memorize_desc: 'Metni kademeli olarak gizleyerek test edin.',
    feat_compare: 'Kari Karşılaştırma',
    feat_compare_desc: 'İki bağımsız ses oynatıcı.',
    feat_i18n: '6 Dil',
    feat_i18n_desc: 'Arapça, İngilizce, Fransızca, Türkçe, İspanyolca, Endonezce arayüz.',
  ...
  es: {
    ...
    features_subtitle: 'Todo lo que necesitas para leer y escuchar el Sagrado Corán.',
    feat_reciters: '500+ Recitadores',
    feat_reciters_desc: 'Escucha recitaciones de cientos de recitadores.',
    feat_tajweed: 'Tajweed en Color',
    feat_tajweed_desc: 'Reglas de tajweed con código de colores.',
    feat_mushaf: '49 Ediciones',
    feat_mushaf_desc: 'Ediciones oficiales del Complejo Rey Fahd.',
    feat_memorize: 'Memorización',
    feat_memorize_desc: 'Oculta texto progresivamente para practicar.',
    feat_compare: 'Comparar Recitadores',
    feat_compare_desc: 'Dos reproductores de audio independientes.',
    feat_i18n: '6 Idiomas',
    feat_i18n_desc: 'Interfaz en árabe, inglés, francés, turco, español e indonesio.',
  ...
  id: {
    ...
    features_subtitle: 'Semua yang Anda butuhkan untuk membaca dan mendengarkan Al-Quran.',
    feat_reciters: '500+ Qari',
    feat_reciters_desc: 'Dengarkan tilawah dari ratusan qari dunia.',
    feat_tajweed: 'Tajweed Berwarna',
    feat_tajweed_desc: 'Hukum tajweed ditampilkan dengan kode warna.',
    feat_mushaf: '49 Edisi Mushaf',
    feat_mushaf_desc: 'Mushaf resmi dari Kompleks Raja Fahd.',
    feat_memorize: 'Mode Hafalan',
    feat_memorize_desc: 'Sembunyikan teks secara bertahap untuk menguji hafalan.',
    feat_compare: 'Bandingkan Qari',
    feat_compare_desc: 'Dua pemutar audio independen.',
    feat_i18n: '6 Bahasa',
    feat_i18n_desc: 'Antarmuka dalam Arab, Inggris, Prancis, Turki, Spanyol, Indonesia.',
    word_meaning: 'Arti',
